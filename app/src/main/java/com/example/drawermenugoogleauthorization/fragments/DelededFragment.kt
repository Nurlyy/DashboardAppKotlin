...
import com.example.drawermenugoogleauthorization.databinding.FragmentDelededBinding
...
class DelededFragment(val act: MainActivity) : Fragment(), FbRcDeletedFragmentAdapter.OnItemClickListener {
    private lateinit var mAuth: FirebaseAuth
    private lateinit var binding: FragmentDelededBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDelededBinding.inflate(inflater, container, false)
        ...
        dbref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if(snapshot.exists()){
                    ...
                    rcView.adapter = FbRcDeletedFragmentAdapter(taskArrayList, this@DelededFragment)
                }
            }
